...
class _MealsListViewState extends State<MealsListView>
  ...
  late List<ProductDataCard> pCardData;

  @override
  void initState() {
    pCardData = ProductDataCard.generateProductDataCards(products);
    animationController = AnimationController(
          ...
          child: Transform(
            ...
            child: Container(
              ...
              child: ListView.builder(
                ...
                itemCount: pCardData.length,
                scrollDirection: Axis.horizontal,
                itemBuilder: (BuildContext context, int index) {
                  final int count =
                      pCardData.length > 10 ? 10 : pCardData.length;
...
class MealsView extends StatelessWidget {
  ...
  final ProductDataCard productCard;
                  ...
                  Padding(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        boxShadow: <BoxShadow>[
                          BoxShadow(
                              color: HexColor(productCard.endColor)
                                  .withOpacity(0.6),
                        ...
                        gradient: LinearGradient(
                          colors: <HexColor>[
                            HexColor(productCard.startColor),
                            HexColor(productCard.endColor),
                          ],
